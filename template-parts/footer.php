<footer style="background-image: url(<?= get_template_directory_uri() . '/assets/images/footer-bg-images.png'?>);"
    ...
    <div
        ...
        <div class="lg:grid lg:gap-36 lg:grid-cols-3 lg:grid-rows-1 lg:h-[300px]">
            ...
            <div
                ...
                <div class="">
                    <a href="#" class="">
                        <img class="w-[50px]"
                            src="<?= get_template_directory_uri() . '/assets/images/logo-webizycode.png'?>"
                ...
                <div class="my-3 inline-block">
                    <a href="https://github.com/webizycode"><i
                            class="fa-brands fa-github text-purple-700 text-2xl mr-2"></i></a>
        ...
        <div class="mt-10 border-t w-full border-t-purple-700 h-20 flex justify-center items-center">
            <p class="text-base font-normal font-Nunito text-gray-500 text-center px-2">Copyright.
                All
                rights
